...
public class SignHighPdf {
    ...
    public static void main(String[] args) throws Exception {
        ...
        byte[] fileData = sign("123456", "E:\\idea\\base\\hello-jsignature-seal-pdf\\src\\main\\resources\\keystore.p12",//
                "E:\\idea\\base\\hello-jsignature-seal-pdf\\src\\main\\resources\\signed.pdf", 350, 290, "Yakir\n2017-12-20");
        FileOutputStream f = new FileOutputStream(new File("E:\\idea\\base\\hello-jsignature-seal-pdf\\src\\main\\resources\\signed2.pdf"));
        f.write(fileData);
        f.close();
    }
}
