...
public class VariableService2 {
    ...
    public void start(){
      ...
      /*  Map<String,Object> map=new HashMap<>();
        ...
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("holiday4");
    ...
    public void completeByVariables(){
        ProcessEngine processEngine = configuration.buildProcessEngine();
        RuntimeService runtimeService = processEngine.getRuntimeService();
        ...
        Holiday holiday = new Holiday();
        holiday.setNum(4F);
        //1.流程实列id  2.流程变量名称  3.流程变量所对应的值
        runtimeService.setVariable("35001","holiday",holiday);

    }

    //完成任务 zhangsan  lisi  wangwu  判断流程变量的请假天数--1天 人事经理存档
    public void completeByTaskVariable(){
        ProcessEngine processEngine = configuration.buildProcessEngine();
        TaskService taskService = processEngine.getTaskService();
        //查询当前是否有任务
        Task task = taskService.createTaskQuery()
